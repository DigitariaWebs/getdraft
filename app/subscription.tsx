...
const styles = StyleSheet.create({
  ...
  // theme.accent (white) instead of the reference's brand.primary — in
  // this dark palette brand.primary is near-black and accentText is
  // black, which would render an invisible button.
  resumeButton: {
    height: 50,
    borderRadius: 25,
    backgroundColor: theme.accent,
